  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        ...
        setTags(post.tags || []);
        if (post.photo) setPreview(post.photo);
      } catch {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (file) {
        ...
        updatedPost.photo = imgRes.data.url;
      }
  ...
  return (
    <div className="write-page fade-in">
      <div className="write-header">
        <h1 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Edit Your Story</h1>
        <button 
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div 
          className={`img-upload-area has-preview`}
